var numBalls = 7; //Set Number of balls
...
function setup() {
  createCanvas(innerWidth, innerWidth/1.5); //innerWidth, innerWidth

  for (var i = 0; i < numBalls; i++) { //Create list with new ball objects
    balls[i] = new Ball(random(width), random(0,height/2), random(50, 100), i,balls, random(0,255),random(0,255),random(0,255), xVelocity, yVelocity);
  }
